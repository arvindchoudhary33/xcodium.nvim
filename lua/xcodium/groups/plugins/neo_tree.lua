...
function M.get(p, opts)
	...
	return {
		...
		NeoTreeGitAdded = { fg = p.git_add, bold = true },
		NeoTreeGitConflict = { fg = p.red, bold = true, italic = true },
		NeoTreeGitDeleted = { fg = p.git_delete, bold = true },
		NeoTreeGitIgnored = { fg = p.fg_subtle },
		NeoTreeGitModified = { fg = p.git_change, bold = true },
		NeoTreeGitRenamed = { fg = p.purple, bold = true },
		NeoTreeGitStaged = { fg = p.git_add, bold = true },
		NeoTreeGitUnstaged = { fg = p.git_change, bold = true },
		NeoTreeGitUntracked = { fg = p.cyan, bold = true },
